...
class Email extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_laboratorist/mail/setting_model' 
		));
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_laboratorist/mail/email');
        } else {
            $data['content'] = $this->load->view('dashboard_laboratorist/mail/email',$data,true);
