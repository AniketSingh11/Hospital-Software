...
class Home extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'dashboard_laboratorist/home_model',  
        )); 
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_laboratorist/home/dashboard',$data,true);
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_laboratorist/home/profile', $data, true);
        $this->load->view('dashboard_laboratorist/main_wrapper',$data);
    } 
    ...
    public function form()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            redirect('dashboard_laboratorist/home/form/');

        } else {
            $user_id = $this->session->userdata('user_id');
            $data['department_list'] = $this->home_model->department_list(); 
            $data['doctor'] = $this->home_model->profile($user_id); 
            $data['content'] = $this->load->view('dashboard_laboratorist/home/profile_form',$data,true);
            $this->load->view('dashboard_laboratorist/main_wrapper',$data);
        } 
    }
