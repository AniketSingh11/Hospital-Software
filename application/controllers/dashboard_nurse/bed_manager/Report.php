...
class Report extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_nurse/bed_manager/report_model', 
		));
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_nurse/bed_manager/report',$data,true);
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_nurse/bed_manager/report_details',$data,true);
		$this->load->view('dashboard_nurse/main_wrapper',$data);
	} 
