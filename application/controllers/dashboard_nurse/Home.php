...
class Home extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_nurse/home/dashboard',$data,true);
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_nurse/home/profile', $data, true);
        $this->load->view('dashboard_nurse/main_wrapper',$data);
    } 
    ...
    public function form()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            redirect('dashboard_nurse/home/form/');

        } else {
            $user_id = $this->session->userdata('user_id');
            $data['department_list'] = $this->home_model->department_list(); 
            $data['doctor'] = $this->home_model->profile($user_id); 
            $data['content'] = $this->load->view('dashboard_nurse/home/profile_form',$data,true);
            $this->load->view('dashboard_nurse/main_wrapper',$data);
        } 
    }
