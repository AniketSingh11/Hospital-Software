...
class Email extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_case_manager/mail/setting_model' 
		));
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_case_manager/mail/email');
        } else {
            $data['content'] = $this->load->view('dashboard_case_manager/mail/email',$data,true);
