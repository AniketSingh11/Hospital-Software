...
class Email extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_receptionist/mail/setting_model' 
		));
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_receptionist/mail/email');
        } else {
            $data['content'] = $this->load->view('dashboard_receptionist/mail/email',$data,true);
