...
class Email extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_representative/mail/setting_model' 
		));
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_representative/mail/email');
        } else {
            $data['content'] = $this->load->view('dashboard_representative/mail/email',$data,true);
