    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_pharmacist/hospital_activities/category") ?>"> <i class="fa fa-list"></i>  <?php echo display('medicine_category_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_pharmacist/hospital_activities/category/form/'.$category->id,'class="form-inner"') ?>
