            ...
            <div class="panel-body  panel-form">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_representative/mail/email','class="form-inner" id="mailForm" ') ?>
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_representative/mail/email/do_upload') ?>',
