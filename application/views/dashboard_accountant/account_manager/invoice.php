                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                ...
                                <td class="center">
                                    <a href="<?php echo base_url("dashboard_accountant/account_manager/invoice/view/$value->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 

                                    <a href="<?php echo base_url("dashboard_accountant/account_manager/invoice/edit/$value->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                    <a href="<?php echo base_url("dashboard_accountant/account_manager/invoice/delete/$value->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                </td>
                            </tr>
                        <?php 
                            $sl++;
