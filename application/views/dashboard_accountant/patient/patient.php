    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <h3><?php echo display('patient') ?></h3>
            </div> 
                        ...
                        <?php if (!empty($patients)) { ?>
                            ...
                            <?php foreach ($patients as $patient) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_accountant/patient/patient/profile/$patient->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td>
