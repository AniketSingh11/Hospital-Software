            ...
            <div class="panel-body  panel-form">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_accountant/mail/email','class="form-inner" id="mailForm" ') ?>
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_accountant/mail/email/do_upload') ?>',
